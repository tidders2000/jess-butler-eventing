...
def index1(request):
    ...
    h = requests.get('https://graph.facebook.com/v4.0/me?fields=id%2Cfeed.limit(6)%7Bfull_picture%2Cmessage%7D&access_token=EAAFwJhMIpkUBACt4KPaeRa03hc3LNMrhWjIAesibZA2LeKuZCnsm9u6ezo8UbXDlMOODW2QOS9ZBzpJjHobM7IxDarRgIE0lEL3MI7ZBSfnPU64gxTfb0hV2VB2RgZB2wmAxpnag6M1ju2K3RjSAZAY3qFvtsZBBQUZC0nEV85VsWwZDZD')
    json2 = h.json()
